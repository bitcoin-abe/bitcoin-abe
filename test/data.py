...
def testnet14(data_base):
    """Testnet test case"""
    chain = Chain.create("Testnet")
    blocks = []
    gen = Gen(chain=chain, db=data_base, blocks=blocks)
    ...
    blocks.append(
        gen.block(transactions=[genesis_coinbase], nTime=1296688602, nNonce=414098458)
    )
